...
class LoginwithEmailPass extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _LoginwithEmailPass();
  }

}

class _LoginwithEmailPass extends State<LoginwithEmailPass>{
                  ...
                  children: [
                    ...
                    BlocConsumer<AuthMianBloc,AuthMainState>(
                        listener: (context,state){
                          ...
                          {
                            ShowSnacBar(context: context, discrip:"Wrong email or password", type: SnackBarType.Error);
                          }
                        ...
                        builder: (context,state) {
                          if(state is AuthInitialState)
                          {
                            return GestureDetector(
                              onTap: (){
                                context.read<AuthMianBloc>().add(LoginUserWithEmail( email: _email.text, pass: _password.text));
                    ...
                    BlocConsumer<AuthMianBloc,AuthMainState>(
                        ...
                        builder: (context,sate) {
                          return SocialIcon('assets/images/google.png', "Login With Google",height,(){
                            context.read<AuthMianBloc>().add(GoogleSignIn());
                          });
                        }
                    ),
                    SizedBox(height: height*0.026,),
                    SocialIcon('assets/images/facebook.png', "Login With Facebook",height,(){}),
